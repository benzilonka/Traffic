...
from server.Data_Analysis import *
...
class TestDataAnalysis (unittest.TestCase):
    ...
    def test_calcTTC(self):
        ...
        self.assertEqual(calc_ttc(vehicles[0],vehicles,5),-1)
        ...
        self.assertEqual(calc_ttc(vehicles[0],vehicles,5),4/5)
    ...
    def test_getDistance(self):
        ...
        self.assertEqual(get_distance(vehicles[0],vehicles),0)
        ...
        self.assertEqual(get_distance(vehicles[0],vehicles),1)
        vehicles = ({ 'bounding_box' : [200, 200, 0,0]},{ 'bounding_box' : [200, 200, 0,0]},{ 'bounding_box' : [200, 200, 0,0]},{ 'bounding_box' : [200, 330, 0,0]})
        self.assertEqual(get_distance(vehicles[0],vehicles),130/5)
        
    
    def test_areInSameLane(self):
        self.assertTrue(are_in_same_lane(85,80))
        self.assertFalse(are_in_same_lane(0,30))
        self.assertTrue(are_in_same_lane(0,22))
        self.assertFalse(are_in_same_lane(40,120))
        self.assertFalse(are_in_same_lane(-30,5))
    ...
    def test_is_vehicle_passed_in_red_light(self): 
        ...
        frame1 = is_vehicle_passed_in_red_light(frame1, None, 200, lanes)
        self.assertFalse(frame1['objects'][0]['passed_in_red'])
        frame2 = is_vehicle_passed_in_red_light(frame2, frame1, 200, lanes)
        self.assertFalse(frame2['objects'][0]['passed_in_red'])
        frame3 = is_vehicle_passed_in_red_light(frame3, frame2, 235, lanes)
        self.assertFalse(frame3['objects'][0]['passed_in_red'])
        frame4 = is_vehicle_passed_in_red_light(frame4, frame3, 238, lanes)
        self.assertTrue(frame4['objects'][0]['passed_in_red'])
        frame5= is_vehicle_passed_in_red_light(frame5, frame4, 238, lanes)
